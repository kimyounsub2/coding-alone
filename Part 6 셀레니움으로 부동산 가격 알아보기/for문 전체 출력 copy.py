...
# click = driver.find_element_by_css_selector(".css-1dbjc4n.r-1habvwh.r-1iusvr4.r-eqz5dr.r-16y2uox.r-1h0z5md.r-1mi0q7o.r-m611by")
...
# while True:
#     # 맨 아래로 스크롤을 내린다.
#     driver.find_element_by_class_name("AptMapOfferLayoutStyle__DetailArea-sc-10mw0f7-2 RnHiG").send_keys(Keys.END)
...
itemlist = driver.find_element_by_css_selector(".css-1dbjc4n.r-18u37iz.r-w3ob7c.r-1mi0q7o.r-qi0n3.r-c9eks5.r-m611by")
